...
void SceneCredits::Init()
{
	...
	pFontL = AEGfxCreateFont("Assets/TokyoMidnight.otf", 50);
	pFontM = AEGfxCreateFont("Assets/liberation-mono.ttf", 40);
	pFontS = AEGfxCreateFont("Assets/MangaBold.otf", 30);
	pFontxS = AEGfxCreateFont("Assets/MangaBold.otf", 20);
